    ...
    <div class="navbar-wrapper">
            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="{{route('dashboard')}}">
                        {{--asset('assets/admin/images/logo/logo.png')--}}
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">
                    {{--Admin Name--}}
                  <span class="user-name text-bold-700"> {{ucwords(Auth::user()->name) }} </span>
{{--                  <span class="user-name text-bold-700"> {{ucwords(Auth::user()) }} </span>--}}
                </span>
                            {{--Admin Personal Photo --}}
                            <span class="avatar avatar-online">
                                <img style="height: 35px;" src="{{Auth::user()->avatar}}"
                                     alt="avatar"><i></i>
                            </span>
                        </a>
